...
* **IN THE HOME PAGE-**
    ...
    * SOCIAL MEDIA LOGO'S CONNECTED DIRECTLY TO THE SOCIAL MEDIA HANDLES OF THE OFFCIAL INFOTSAV FEST.
...
* **ON HOVERING ANY (PARTICULAR) EVENT'S PHOTO IN THE EVENTS PAGE A DROP DOWN COMES FROM THE TOP OF THE HOVED EVENT PIC WITH SOME DETAILS AND A EXPLORE BUTTON WHICH ON HOVERING SHIFTS TO LEFT AND A ARROW APPEARS TO ITS RIGHT LIKE THIS "EXPLORE >>" WHERE ">>" IS THE "\00BB" UNICODE CHARACHTER; THE BACKGROUND COLOUR OF THE BUTTON ALSO CHANGES.**
